...
public abstract class RTNode {
    ...
    protected int level;            // 节点所在的层
    protected Rectangle[] datas;    // 条目
    protected RTNode parent;        // 父节点
    protected int usedSpace;        // 节点已用的空间
     ...
     * @return 两个组中的条目的索引
     */
    protected int[][] quadraticSplit(Rectangle rectangle) throws CloneNotSupportedException {
        if (rectangle == null) {
     ...
     */
    protected int[] pickSeeds() throws CloneNotSupportedException {
     ...
     */
    public Rectangle getNodeRectangle() throws CloneNotSupportedException {
        if (usedSpace > 0) {
